...
def propogation(op2):
    ...
    if(_int_type >= 0): 
        ...
        wp_arI = array('f', [0]*wfr2.mesh.ne*wfr2.mesh.nx*wfr2.mesh.ny)
        print ("@@@")
        ...
        if(True):
            ...
            srwl_uti_save_intens_ascii(wp_arI, wfr2.mesh,"Intensity_matchMask.dat", 0, ['Photon Energy', 'Horizontal Position', 'Vertical Position', ''], _arUnits=['eV', 'm', 'm', sValUnitName])
        return wp_arI           
